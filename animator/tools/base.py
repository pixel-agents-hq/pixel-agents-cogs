"""The contract every animator tool implements.

A deliberate parallel copy of `painter/tools/base.py`'s `ToolSpec` Protocol
(itself a parallel copy of architect's/pico's own), not a shared import --
