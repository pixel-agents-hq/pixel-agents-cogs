...
A parallel copy of `architect/infrastructure/corridor_llm.py` (itself a
parallel copy of pico's own) -- see docs/architect-design.md on why each
agent holds its own copy of this small adapter rather than importing one
from another.
