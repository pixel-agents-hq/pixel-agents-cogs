...
The straightforward `from .telephonepole import ...` would force
...
_DATA_STATEMENT = "This cog does not persistently store any data or metadata about Discord users. It stores bot-owner-registered third-party MCP server names/URLs and a per-server, per-agent access list."
...
async def setup(bot: Red) -> None:
    ...
    await bot.add_cog(Telephonepole(bot))
