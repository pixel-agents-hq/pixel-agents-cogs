"""Install stubs before any toolbox module is imported.
...
last silently wins for the whole pytest session), and this cog already
depends on corridor via required_cogs.
"""
