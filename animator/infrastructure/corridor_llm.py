...
A parallel copy of `painter/infrastructure/corridor_llm.py` (itself a
parallel copy of architect's/pico's own) -- see docs/architect-design.md on
why each agent holds its own copy of this small adapter rather than
