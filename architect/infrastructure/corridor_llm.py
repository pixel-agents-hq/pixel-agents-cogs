...
A parallel copy of `pico/infrastructure/corridor_llm.py` -- see
docs/architect-design.md on why pico and architect each hold their own
copy of this small adapter rather than importing one from the other.
