...
from floorplan.adapters.settings_panel import (
    SettingsPanelView,
    SettingsRuntimeSnapshot,
    SettingsValueModal,
)
from floorplan.application import SettingsService
from floorplan.domain import GlobalSettings, GuildSettings
...
class TestSettingsPanelCommand(unittest.IsolatedAsyncioTestCase):
    async def test_command_is_admin_only_and_slash_response_is_ephemeral(self) -> None:
        command = FloorplanCog.floorplan_group.subcommands["settings"]
