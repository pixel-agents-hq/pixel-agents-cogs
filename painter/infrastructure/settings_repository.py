...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "Use describe_colors to see current colors, and recolor_tiles/"
    "recolor_furniture/recolor_furniture_by_style to change them -- these "
    "edit the shared layout directly and persist immediately. "
