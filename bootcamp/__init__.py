...
The straightforward `from .bootcamp import ...` would force
...
_DATA_STATEMENT = "This cog sends A2A task messages and direct-invoke prompts it receives to corridor's configured LLM endpoint. It does not persistently store any data or metadata about Discord users."
...
async def setup(bot: Red) -> None:
    ...
    await bot.add_cog(Bootcamp(bot))
