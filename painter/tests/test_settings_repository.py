"""Exercises RedPainterRepository against the fake Config installed by the
...
class TestRedPainterRepository(unittest.IsolatedAsyncioTestCase):
    def setUp(self) -> None:
        self.repository = RedPainterRepository.create(cog=object())
