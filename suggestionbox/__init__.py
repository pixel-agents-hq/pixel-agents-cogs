...
The straightforward `from .suggestionbox import ...` would force
...
_DATA_STATEMENT = "This cog does not persistently store any data or metadata about Discord users. It stores a bot-owner-configured feedback channel, MCP listener host/port, and a per-agent access list."
