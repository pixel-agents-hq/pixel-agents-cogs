...
Pairs each endpoint the floorplan package actually calls with the pydantic model
(if any, from floorplan/contracts/pixel_index.py) that describes the response shape it
