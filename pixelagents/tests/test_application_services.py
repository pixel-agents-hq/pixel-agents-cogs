...
from pixelagents.application import OfficeService, PresenceService, TaskSupervisor
from pixelagents.application.office import JS_MAX_SAFE
...
from pixelagents.infrastructure.discord import member_snapshot, message_snapshot
from pixelagents.pixelagents import pixelagents as PixelAgentsCog
from pixelagents.tests.conftest import _FakeClientWebSocketResponse
...
class TestTaskSupervisor(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_failure_is_observed_and_isolated(self) -> None:
        ...
        with self.assertLogs("pixelagents.application.tasks", level=logging.ERROR) as logs:
