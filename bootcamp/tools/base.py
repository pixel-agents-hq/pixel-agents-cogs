"""The contract every bootcamp tool implements.

A deliberate parallel copy of `pico/tools/base.py`'s `ToolSpec` Protocol,
not a shared import -- pico and bootcamp are independent agents with
independent tool sets; see docs/bootcamp-design.md on why this is
