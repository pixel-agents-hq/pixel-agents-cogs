...
class CatalogueCommandsMixin(PixelAgentsBase):
    ...
    @AdminCommandsMixin.pixelagents_group.group(name="index", invoke_without_command=True)
    ...
    @AdminCommandsMixin.pixelagents_group.group(name="layout", invoke_without_command=True)
